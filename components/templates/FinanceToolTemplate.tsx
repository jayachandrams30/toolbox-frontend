    ...
    return (
        <div className="border border-outline-variant rounded-xl p-8 bg-surface-container-lowest transition-colors">
            ...
            <div className="space-y-6">
                <div>
                    <label className="block font-label-sm text-[12px] text-on-surface-variant mb-2">Amount</label>
                    <input type="number" className="w-full h-[48px] px-4 bg-surface-container-lowest border border-outline-variant rounded-lg font-body-md text-[16px] text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors" placeholder="0.00" />
                </div>
